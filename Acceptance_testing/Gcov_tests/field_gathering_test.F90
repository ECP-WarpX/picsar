...
PROGRAM field_gathering_3d_test
  ...
  DO i = 1,n
		write(0,'(A40,7(X,E12.5))') name(i), sumex(i), sumey(i), sumez(i), errex(i), errey(i), errez(i), te(i)
	ENDDO
  ...
  write(0,'(" _____________________________________________________")')
  DO i = 1,n
		write(0,'(A40,7(X,E12.5))') name(i), sumbx(i), sumby(i), sumbz(i), errbx(i), errby(i), errbz(i), tb(i)
	ENDDO
  ...
  write(0,'(A40, 7(A13))') "Subrtouines", "sum(bx)", "sum(by)", "sum(bz)", "err bx", "err by", "err bz", "time (s)"
  write(0,'(" _____________________________________________________")')
  DO i = 1,n
		write(0,'(A40,7(X,E12.5))') name(i), sumbx(i), sumby(i), sumbz(i), errbx(i), errby(i), errbz(i), tb(i)
	ENDDO
  ...
  !write(0,*) 'test 2: gete3d_energy_conserving_scalar_1_1_1'
  name(i) = 'gete3d_energy_conserving_linear_3_3_3'
  ex = 0
  ey = 0
  ez = 0
  te(i) = MPI_WTIME() -t0  
  ...
  name(i) = 'getb3d_energy_conserving_linear_3_3_3'
  bx = 0
  by = 0
  bz = 0
  t0 = MPI_WTIME()
