...
% This section is commented out because the axi-symmetrical algorithm
% is not yet implemented in PICSAR.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\section{Axi-symmetry and azimuthal Fourier decomposition}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\input{Cylindrical/Cylindrical.tex}
...
\begin{figure}
%   \centering
   \includegraphics[width=120mm]{Input.png}
