...
tile_mpi_part_com_test:
	...
	mpirun -n 2 ./Acceptance_testing/Gcov_tests/tile_mpi_part_com_test
...
test_lb:
	cd Acceptance_testing/Gcov_tests && \
	export OMP_NUM_THREADS=1 &&\
	mpirun -np 2 ./maxwell_2d_test input_file.pixr --l_spectral .TRUE. --nsteps 81 --nprocz 2 --fftw_with_mpi .TRUE. --fftw_hybrid .TRUE. --nb_group 1 \
	is_lb_grp .TRUE.	
