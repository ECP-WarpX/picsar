...
jy = 0.0_num
jz = 0.0_num
CALL pxrdepose_currents_on_grid_jxjyjz_sub(jx,jy,jz,nx,ny,nz,nxjguards,nyjguards,nzjguards, &
...
!===============================================================================
SUBROUTINE pxrdepose_currents_on_grid_jxjyjz_sub(jxg,jyg,jzg,nxx,nyy,nzz,nxjguard,nyjguard,nzjguard, &
    ...
    DO iy=1,ntiley
        DO ix=1,ntilex
            DO ispecies=1, nspecies ! LOOP ON SPECIES
                ...
                CALL warp_depose_jxjyjz_esirkepov_n(curr_tile%jxtile,curr_tile%jytile,curr_tile%jztile,count,        &
...
END SUBROUTINE pxrdepose_currents_on_grid_jxjyjz_sub
