...
! ______________________________________________________________________________
  ...
  INTEGER(isp)                           :: nn,n
  REAL(num)                              :: dxi, dyi, dzi, x, y, z, xint, yint, zint
  REAL(num)                              :: xintsq,oxint,yintsq,oyint,zintsq,ozint
...
! !DIR DISTRIBUTE POINT
    ...
    DO n=1,MIN(lvect,np-ip+1)
      ...
      a = (sx0(n,-1)*exg(j0-1,k-1,l-1) &
          + sx0(n,0)*exg(j0,k-1,l-1) &
          + sx0(n,1)*exg(j0+1,k-1,l-1) &
          + sx0(n,2)*exg(j0+2,k-1,l-1))*sy(n,-1)
      a = a + (sx0(n,-1)*exg(j0-1,k,l-1) &
          + sx0(n,0)*exg(j0,k,l-1) &
          + sx0(n,1)*exg(j0+1,k,l-1) &
          + sx0(n,2)*exg(j0+2,k,l-1))*sy(n,0)
      a = a + (sx0(n,-1)*exg(j0-1,k+1,l-1) &
          + sx0(n,0)*exg(j0,k+1,l-1) &
          + sx0(n,1)*exg(j0+1,k+1,l-1) &
          + sx0(n,2)*exg(j0+2,k+1,l-1))*sy(n,1)
      a = a + (sx0(n,-1)*exg(j0-1,k+2,l-1) &
          + sx0(n,0)*exg(j0,k+2,l-1) &
          + sx0(n,1)*exg(j0+1,k+2,l-1) &
          + sx0(n,2)*exg(j0+2,k+2,l-1))*sy(n,2)
      ex(nn) = ex(nn) + a*sz(n,-1)
      a = (sx0(n,-1)*exg(j0-1,k-1,l) &
          + sx0(n,0)*exg(j0,k-1,l) &
          + sx0(n,1)*exg(j0+1,k-1,l) &
          + sx0(n,2)*exg(j0+2,k-1,l))*sy(n,-1)
      a = a + (sx0(n,-1)*exg(j0-1,k,l) &
          + sx0(n,0)*exg(j0,k,l) &
          + sx0(n,1)*exg(j0+1,k,l) &
          + sx0(n,2)*exg(j0+2,k,l))*sy(n,0)
      a = a + (sx0(n,-1)*exg(j0-1,k+1,l) &
          + sx0(n,0)*exg(j0,k+1,l) &
          + sx0(n,1)*exg(j0+1,k+1,l) &
          + sx0(n,2)*exg(j0+2,k+1,l))*sy(n,1)
      a = a + (sx0(n,-1)*exg(j0-1,k+2,l) &
          + sx0(n,0)*exg(j0,k+2,l) &
          + sx0(n,1)*exg(j0+1,k+2,l) &
          + sx0(n,2)*exg(j0+2,k+2,l))*sy(n,2)
      ex(nn) = ex(nn) + a*sz(n,0)
      a = (sx0(n,-1)*exg(j0-1,k-1,l+1) &
          + sx0(n,0)*exg(j0,k-1,l+1) &
          + sx0(n,1)*exg(j0+1,k-1,l+1) &
      ...
      a = (sx0(n,-1)*exg(j0-1,k-1,l+2) &
          + sx0(n,0)*exg(j0,k-1,l+2) &
          + sx0(n,1)*exg(j0+1,k-1,l+2) &
          + sx0(n,2)*exg(j0+2,k-1,l+2))*sy(n,-1)
      a = a + (sx0(n,-1)*exg(j0-1,k,l+2) &
          + sx0(n,0)*exg(j0,k,l+2) &
          + sx0(n,1)*exg(j0+1,k,l+2) &
          + sx0(n,2)*exg(j0+2,k,l+2))*sy(n,0)
      a = a + (sx0(n,-1)*exg(j0-1,k+1,l+2) &
          + sx0(n,0)*exg(j0,k+1,l+2) &
          + sx0(n,1)*exg(j0+1,k+1,l+2) &
          + sx0(n,2)*exg(j0+2,k+1,l+2))*sy(n,1)
      a = a + (sx0(n,-1)*exg(j0-1,k+2,l+2) &
          + sx0(n,0)*exg(j0,k+2,l+2) &
          + sx0(n,1)*exg(j0+1,k+2,l+2) &
          + sx0(n,2)*exg(j0+2,k+2,l+2))*sy(n,2)
      ex(nn) = ex(nn) + a*sz(n,2)
      ...
      a = a + (sx(n,-1)*eyg(j-1,k0+1,l-1) &
          ...
          + sx(n,1)*eyg(j+1,k0+1,l-1) &
          + sx(n,2)*eyg(j+2,k0+1,l-1))*sy0(n,1)
      a = a + (sx(n,-1)*eyg(j-1,k0+2,l-1) &
          + sx(n,0)*eyg(j,k0+2,l-1) &
          + sx(n,1)*eyg(j+1,k0+2,l-1) &
          + sx(n,2)*eyg(j+2,k0+2,l-1))*sy0(n,2)
      ey(nn) = ey(nn) + a*sz(n,-1)
      a = (sx(n,-1)*eyg(j-1,k0-1,l) &
          + sx(n,0)*eyg(j,k0-1,l) &
          + sx(n,1)*eyg(j+1,k0-1,l) &
      ...
      a = a + (sx(n,-1)*eyg(j-1,k0+1,l) &
          ...
          + sx(n,1)*eyg(j+1,k0+1,l) &
          + sx(n,2)*eyg(j+2,k0+1,l))*sy0(n,1)
      a = a + (sx(n,-1)*eyg(j-1,k0+2,l) &
          + sx(n,0)*eyg(j,k0+2,l) &
          + sx(n,1)*eyg(j+1,k0+2,l) &
          + sx(n,2)*eyg(j+2,k0+2,l))*sy0(n,2)
      ey(nn) = ey(nn) + a*sz(n,0)
      a = (sx(n,-1)*eyg(j-1,k0-1,l+1) &
          + sx(n,0)*eyg(j,k0-1,l+1) &
          + sx(n,1)*eyg(j+1,k0-1,l+1) &
      ...
      a = a + (sx(n,-1)*eyg(j-1,k0+1,l+2) &
          ...
          + sx(n,1)*eyg(j+1,k0+1,l+2) &
          + sx(n,2)*eyg(j+2,k0+1,l+2))*sy0(n,1)
      a = a + (sx(n,-1)*eyg(j-1,k0+2,l+2) &
          + sx(n,0)*eyg(j,k0+2,l+2) &
          + sx(n,1)*eyg(j+1,k0+2,l+2) &
          + sx(n,2)*eyg(j+2,k0+2,l+2))*sy0(n,2)
      ey(nn) = ey(nn) + a*sz(n,2)
      ...
      a = a + (sx(n,-1)*ezg(j-1,k+2,l0+1) &
          ...
          + sx(n,2)*ezg(j+2,k+2,l0+1))*sy(n,2)
      ez(nn) = ez(nn) + a*sz0(n,1)
      a = (sx(n,-1)*ezg(j-1,k-1,l0+2) &
          + sx(n,0)*ezg(j,k-1,l0+2) &
          + sx(n,1)*ezg(j+1,k-1,l0+2) &
          + sx(n,2)*ezg(j+2,k-1,l0+2))*sy(n,-1)
      a = a + (sx(n,-1)*ezg(j-1,k,l0+2) &
          + sx(n,0)*ezg(j,k,l0+2) &
          + sx(n,1)*ezg(j+1,k,l0+2) &
          + sx(n,2)*ezg(j+2,k,l0+2))*sy(n,0)
      a = a + (sx(n,-1)*ezg(j-1,k+1,l0+2) &
          + sx(n,0)*ezg(j,k+1,l0+2) &
          + sx(n,1)*ezg(j+1,k+1,l0+2) &
          + sx(n,2)*ezg(j+2,k+1,l0+2))*sy(n,1)
      a = a + (sx(n,-1)*ezg(j-1,k+2,l0+2) &
          + sx(n,0)*ezg(j,k+2,l0+2) &
          + sx(n,1)*ezg(j+1,k+2,l0+2) &
          + sx(n,2)*ezg(j+2,k+2,l0+2))*sy(n,2)
...
!!DIR DISTRIBUTE POINT
    ...
    DO n=1,MIN(lvect,np-ip+1)
      ...
      a = a + (sx(n,-1)*bxg(j-1,k0+1,l0-1) &
          ...
          + sx(n,1)*bxg(j+1,k0+1,l0-1) &
          + sx(n,2)*bxg(j+2,k0+1,l0-1))*sy0(n,1)
      a = a + (sx(n,-1)*bxg(j-1,k0+2,l0-1) &
          + sx(n,0)*bxg(j,k0+2,l0-1) &
          + sx(n,1)*bxg(j+1,k0+2,l0-1) &
          + sx(n,2)*bxg(j+2,k0+2,l0-1))*sy0(n,2)
      bx(nn) = bx(nn) + a*sz0(n,-1)
      a = (sx(n,-1)*bxg(j-1,k0-1,l0) &
          + sx(n,0)*bxg(j,k0-1,l0) &
          + sx(n,1)*bxg(j+1,k0-1,l0) &
      ...
      a = a + (sx(n,-1)*bxg(j-1,k0+1,l0) &
          ...
          + sx(n,1)*bxg(j+1,k0+1,l0) &
          + sx(n,2)*bxg(j+2,k0+1,l0))*sy0(n,1)
      a = a + (sx(n,-1)*bxg(j-1,k0+2,l0) &
          + sx(n,0)*bxg(j,k0+2,l0) &
          + sx(n,1)*bxg(j+1,k0+2,l0) &
          + sx(n,2)*bxg(j+2,k0+2,l0))*sy0(n,2)
      bx(nn) = bx(nn) + a*sz0(n,0)
      a = (sx(n,-1)*bxg(j-1,k0-1,l0+1) &
          + sx(n,0)*bxg(j,k0-1,l0+1) &
          + sx(n,1)*bxg(j+1,k0-1,l0+1) &
      ...
      a = a + (sx(n,-1)*bxg(j-1,k0+2,l0+1) &
          ...
          + sx(n,2)*bxg(j+2,k0+2,l0+1))*sy0(n,2)
      bx(nn) = bx(nn) + a*sz0(n,1)
      a = (sx(n,-1)*bxg(j-1,k0-1,l0+2) &
          + sx(n,0)*bxg(j,k0-1,l0+2) &
          + sx(n,1)*bxg(j+1,k0-1,l0+2) &
          + sx(n,2)*bxg(j+2,k0-1,l0+2))*sy0(n,-1)
      a = a + (sx(n,-1)*bxg(j-1,k0,l0+2) &
          + sx(n,0)*bxg(j,k0,l0+2) &
          + sx(n,1)*bxg(j+1,k0,l0+2) &
          + sx(n,2)*bxg(j+2,k0,l0+2))*sy0(n,0)
      a = a + (sx(n,-1)*bxg(j-1,k0+1,l0+2) &
          + sx(n,0)*bxg(j,k0+1,l0+2) &
          + sx(n,1)*bxg(j+1,k0+1,l0+2) &
          + sx(n,2)*bxg(j+2,k0+1,l0+2))*sy0(n,1)
      a = a + (sx(n,-1)*bxg(j-1,k0+2,l0+2) &
          + sx(n,0)*bxg(j,k0+2,l0+2) &
          + sx(n,1)*bxg(j+1,k0+2,l0+2) &
          + sx(n,2)*bxg(j+2,k0+2,l0+2))*sy0(n,2)
      bx(nn) = bx(nn) + a*sz0(n,2)

      ! Compute By on particle
      a = (sx0(n,-1)*byg(j0-1,k-1,l0-1) &
          + sx0(n,0)*byg(j0,k-1,l0-1) &
          + sx0(n,1)*byg(j0+1,k-1,l0-1) &
          + sx0(n,2)*byg(j0+2,k-1,l0-1))*sy(n,-1)
      a = a + (sx0(n,-1)*byg(j0-1,k,l0-1) &
          + sx0(n,0)*byg(j0,k,l0-1) &
          + sx0(n,1)*byg(j0+1,k,l0-1) &
          + sx0(n,2)*byg(j0+2,k,l0-1))*sy(n,0)
      a = a + (sx0(n,-1)*byg(j0-1,k+1,l0-1) &
          + sx0(n,0)*byg(j0,k+1,l0-1) &
          + sx0(n,1)*byg(j0+1,k+1,l0-1) &
          + sx0(n,2)*byg(j0+2,k+1,l0-1))*sy(n,1)
      a = a + (sx0(n,-1)*byg(j0-1,k+2,l0-1) &
          + sx0(n,0)*byg(j0,k+2,l0-1) &
          + sx0(n,1)*byg(j0+1,k+2,l0-1) &
          + sx0(n,2)*byg(j0+2,k+2,l0-1))*sy(n,2)
      by(nn) = by(nn) + a*sz0(n,-1)
      a = (sx0(n,-1)*byg(j0-1,k-1,l0) &
          + sx0(n,0)*byg(j0,k-1,l0) &
          + sx0(n,1)*byg(j0+1,k-1,l0) &
          + sx0(n,2)*byg(j0+2,k-1,l0))*sy(n,-1)
      a = a + (sx0(n,-1)*byg(j0-1,k,l0) &
          + sx0(n,0)*byg(j0,k,l0) &
          + sx0(n,1)*byg(j0+1,k,l0) &
          + sx0(n,2)*byg(j0+2,k,l0))*sy(n,0)
      a = a + (sx0(n,-1)*byg(j0-1,k+1,l0) &
          + sx0(n,0)*byg(j0,k+1,l0) &
          + sx0(n,1)*byg(j0+1,k+1,l0) &
          + sx0(n,2)*byg(j0+2,k+1,l0))*sy(n,1)
      a = a + (sx0(n,-1)*byg(j0-1,k+2,l0) &
          + sx0(n,0)*byg(j0,k+2,l0) &
          + sx0(n,1)*byg(j0+1,k+2,l0) &
          + sx0(n,2)*byg(j0+2,k+2,l0))*sy(n,2)
      by(nn) = by(nn) + a*sz0(n,0)
      a = (sx0(n,-1)*byg(j0-1,k-1,l0+1) &
          + sx0(n,0)*byg(j0,k-1,l0+1) &
          + sx0(n,1)*byg(j0+1,k-1,l0+1) &
      ...
      a = a + (sx0(n,-1)*byg(j0-1,k+2,l0+1) &
          ...
          + sx0(n,2)*byg(j0+2,k+2,l0+1))*sy(n,2)
      by(nn) = by(nn) + a*sz0(n,1)
      a = (sx0(n,-1)*byg(j0-1,k-1,l0+2) &
          + sx0(n,0)*byg(j0,k-1,l0+2) &
          + sx0(n,1)*byg(j0+1,k-1,l0+2) &
          + sx0(n,2)*byg(j0+2,k-1,l0+2))*sy(n,-1)
      a = a + (sx0(n,-1)*byg(j0-1,k,l0+2) &
          + sx0(n,0)*byg(j0,k,l0+2) &
          + sx0(n,1)*byg(j0+1,k,l0+2) &
          + sx0(n,2)*byg(j0+2,k,l0+2))*sy(n,0)
      a = a + (sx0(n,-1)*byg(j0-1,k+1,l0+2) &
          + sx0(n,0)*byg(j0,k+1,l0+2) &
          + sx0(n,1)*byg(j0+1,k+1,l0+2) &
          + sx0(n,2)*byg(j0+2,k+1,l0+2))*sy(n,1)
      a = a + (sx0(n,-1)*byg(j0-1,k+2,l0+2) &
          + sx0(n,0)*byg(j0,k+2,l0+2) &
          + sx0(n,1)*byg(j0+1,k+2,l0+2) &
          + sx0(n,2)*byg(j0+2,k+2,l0+2))*sy(n,2)
      by(nn) = by(nn) + a*sz0(n,2)

      ! Compute Bz on particle
      a = (sx0(n,-1)*bzg(j0-1,k0-1,l-1) &
          + sx0(n,0)*bzg(j0,k0-1,l-1) &
          + sx0(n,1)*bzg(j0+1,k0-1,l-1) &
          + sx0(n,2)*bzg(j0+2,k0-1,l-1))*sy0(n,-1)
      a = a + (sx0(n,-1)*bzg(j0-1,k0,l-1) &
          + sx0(n,0)*bzg(j0,k0,l-1) &
          + sx0(n,1)*bzg(j0+1,k0,l-1) &
          + sx0(n,2)*bzg(j0+2,k0,l-1))*sy0(n,0)
      a = a + (sx0(n,-1)*bzg(j0-1,k0+1,l-1) &
          + sx0(n,0)*bzg(j0,k0+1,l-1) &
          + sx0(n,1)*bzg(j0+1,k0+1,l-1) &
          + sx0(n,2)*bzg(j0+2,k0+1,l-1))*sy0(n,1)
      a = a + (sx0(n,-1)*bzg(j0-1,k0+2,l-1) &
          + sx0(n,0)*bzg(j0,k0+2,l-1) &
          + sx0(n,1)*bzg(j0+1,k0+2,l-1) &
          + sx0(n,2)*bzg(j0+2,k0+2,l-1))*sy0(n,2)
      bz(nn) = bz(nn) + a*sz(n,-1)
      a = (sx0(n,-1)*bzg(j0-1,k0-1,l) &
          + sx0(n,0)*bzg(j0,k0-1,l) &
          + sx0(n,1)*bzg(j0+1,k0-1,l) &
          + sx0(n,2)*bzg(j0+2,k0-1,l))*sy0(n,-1)
      a = a + (sx0(n,-1)*bzg(j0-1,k0,l) &
          + sx0(n,0)*bzg(j0,k0,l) &
          + sx0(n,1)*bzg(j0+1,k0,l) &
          + sx0(n,2)*bzg(j0+2,k0,l))*sy0(n,0)
      a = a + (sx0(n,-1)*bzg(j0-1,k0+1,l) &
          + sx0(n,0)*bzg(j0,k0+1,l) &
          + sx0(n,1)*bzg(j0+1,k0+1,l) &
          + sx0(n,2)*bzg(j0+2,k0+1,l))*sy0(n,1)
      a = a + (sx0(n,-1)*bzg(j0-1,k0+2,l) &
          + sx0(n,0)*bzg(j0,k0+2,l) &
          + sx0(n,1)*bzg(j0+1,k0+2,l) &
          + sx0(n,2)*bzg(j0+2,k0+2,l))*sy0(n,2)
      bz(nn) = bz(nn) + a*sz(n,0)
      a = (sx0(n,-1)*bzg(j0-1,k0-1,l+1) &
          + sx0(n,0)*bzg(j0,k0-1,l+1) &
          + sx0(n,1)*bzg(j0+1,k0-1,l+1) &
      ...
      a = (sx0(n,-1)*bzg(j0-1,k0-1,l+2) &
          + sx0(n,0)*bzg(j0,k0-1,l+2) &
          + sx0(n,1)*bzg(j0+1,k0-1,l+2) &
          + sx0(n,2)*bzg(j0+2,k0-1,l+2))*sy0(n,-1)
      a = a + (sx0(n,-1)*bzg(j0-1,k0,l+2) &
          + sx0(n,0)*bzg(j0,k0,l+2) &
          + sx0(n,1)*bzg(j0+1,k0,l+2) &
          + sx0(n,2)*bzg(j0+2,k0,l+2))*sy0(n,0)
      a = a + (sx0(n,-1)*bzg(j0-1,k0+1,l+2) &
          + sx0(n,0)*bzg(j0,k0+1,l+2) &
          + sx0(n,1)*bzg(j0+1,k0+1,l+2) &
          + sx0(n,2)*bzg(j0+2,k0+1,l+2))*sy0(n,1)
      a = a + (sx0(n,-1)*bzg(j0-1,k0+2,l+2) &
          + sx0(n,0)*bzg(j0,k0+2,l+2) &
          + sx0(n,1)*bzg(j0+1,k0+2,l+2) &
          + sx0(n,2)*bzg(j0+2,k0+2,l+2))*sy0(n,2)
      bz(nn) = bz(nn) + a*sz(n,2)
...
!> @param[in] l_lower_order_in_v lower order for the interpolation
!
SUBROUTINE geteb3d_energy_conserving_vecV2_3_3_3(np,xp,yp,zp,ex,ey,ez,bx,by,bz, &
                                           xmin,ymin,zmin,       &
                                           dx,dy,dz,nx,ny,nz,nxguard,nyguard,nzguard, &
                                           exg,eyg,ezg,bxg,byg,bzg,lvect,l_lower_order_in_v )
! ______________________________________________________________________________
...
!!DIR DISTRIBUTE POINT
    ...
    DO n=1,MIN(lvect,np-ip+1)
      ...
      a = (sx0(-1)*exg(j0-1,k-1,l-1) &
          + sx0(0)*exg(j0,k-1,l-1) &
          + sx0(1)*exg(j0+1,k-1,l-1) &
          + sx0(2)*exg(j0+2,k-1,l-1))*sy(-1)
      a = a + (sx0(-1)*exg(j0-1,k,l-1) &
          + sx0(0)*exg(j0,k,l-1) &
          + sx0(1)*exg(j0+1,k,l-1) &
          + sx0(2)*exg(j0+2,k,l-1))*sy(0)
      a = a + (sx0(-1)*exg(j0-1,k+1,l-1) &
          + sx0(0)*exg(j0,k+1,l-1) &
          + sx0(1)*exg(j0+1,k+1,l-1) &
          + sx0(2)*exg(j0+2,k+1,l-1))*sy(1)
      a = a + (sx0(-1)*exg(j0-1,k+2,l-1) &
          + sx0(0)*exg(j0,k+2,l-1) &
          + sx0(1)*exg(j0+1,k+2,l-1) &
          + sx0(2)*exg(j0+2,k+2,l-1))*sy(2)
      ex(nn) = ex(nn) + a*sz(-1)
      a = (sx0(-1)*exg(j0-1,k-1,l) &
          + sx0(0)*exg(j0,k-1,l) &
          + sx0(1)*exg(j0+1,k-1,l) &
          + sx0(2)*exg(j0+2,k-1,l))*sy(-1)
      a = a + (sx0(-1)*exg(j0-1,k,l) &
          + sx0(0)*exg(j0,k,l) &
          + sx0(1)*exg(j0+1,k,l) &
          + sx0(2)*exg(j0+2,k,l))*sy(0)
      a = a + (sx0(-1)*exg(j0-1,k+1,l) &
          + sx0(0)*exg(j0,k+1,l) &
          + sx0(1)*exg(j0+1,k+1,l) &
          + sx0(2)*exg(j0+2,k+1,l))*sy(1)
      a = a + (sx0(-1)*exg(j0-1,k+2,l) &
          + sx0(0)*exg(j0,k+2,l) &
          + sx0(1)*exg(j0+1,k+2,l) &
          + sx0(2)*exg(j0+2,k+2,l))*sy(2)
      ex(nn) = ex(nn) + a*sz(0)
      a = (sx0(-1)*exg(j0-1,k-1,l+1) &
          + sx0(0)*exg(j0,k-1,l+1) &
          + sx0(1)*exg(j0+1,k-1,l+1) &
      ...
      a = (sx0(-1)*exg(j0-1,k-1,l+2) &
          + sx0(0)*exg(j0,k-1,l+2) &
          + sx0(1)*exg(j0+1,k-1,l+2) &
          + sx0(2)*exg(j0+2,k-1,l+2))*sy(-1)
      a = a + (sx0(-1)*exg(j0-1,k,l+2) &
          + sx0(0)*exg(j0,k,l+2) &
          + sx0(1)*exg(j0+1,k,l+2) &
          + sx0(2)*exg(j0+2,k,l+2))*sy(0)
      a = a + (sx0(-1)*exg(j0-1,k+1,l+2) &
          + sx0(0)*exg(j0,k+1,l+2) &
          + sx0(1)*exg(j0+1,k+1,l+2) &
          + sx0(2)*exg(j0+2,k+1,l+2))*sy(1)
      a = a + (sx0(-1)*exg(j0-1,k+2,l+2) &
          + sx0(0)*exg(j0,k+2,l+2) &
          + sx0(1)*exg(j0+1,k+2,l+2) &
          + sx0(2)*exg(j0+2,k+2,l+2))*sy(2)
      ex(nn) = ex(nn) + a*sz(2)
      ...
      a = a + (sx(-1)*eyg(j-1,k0+1,l-1) &
          ...
          + sx(1)*eyg(j+1,k0+1,l-1) &
          + sx(2)*eyg(j+2,k0+1,l-1))*sy0(1)
      a = a + (sx(-1)*eyg(j-1,k0+2,l-1) &
          + sx(0)*eyg(j,k0+2,l-1) &
          + sx(1)*eyg(j+1,k0+2,l-1) &
          + sx(2)*eyg(j+2,k0+2,l-1))*sy0(2)
      ey(nn) = ey(nn) + a*sz(-1)
      a = (sx(-1)*eyg(j-1,k0-1,l) &
          + sx(0)*eyg(j,k0-1,l) &
          + sx(1)*eyg(j+1,k0-1,l) &
      ...
      a = a + (sx(-1)*eyg(j-1,k0+1,l) &
          ...
          + sx(1)*eyg(j+1,k0+1,l) &
          + sx(2)*eyg(j+2,k0+1,l))*sy0(1)
      a = a + (sx(-1)*eyg(j-1,k0+2,l) &
          + sx(0)*eyg(j,k0+2,l) &
          + sx(1)*eyg(j+1,k0+2,l) &
          + sx(2)*eyg(j+2,k0+2,l))*sy0(2)
      ey(nn) = ey(nn) + a*sz(0)
      a = (sx(-1)*eyg(j-1,k0-1,l+1) &
          + sx(0)*eyg(j,k0-1,l+1) &
          + sx(1)*eyg(j+1,k0-1,l+1) &
      ...
      a = a + (sx(-1)*eyg(j-1,k0+1,l+2) &
          ...
          + sx(1)*eyg(j+1,k0+1,l+2) &
          + sx(2)*eyg(j+2,k0+1,l+2))*sy0(1)
      a = a + (sx(-1)*eyg(j-1,k0+2,l+2) &
          + sx(0)*eyg(j,k0+2,l+2) &
          + sx(1)*eyg(j+1,k0+2,l+2) &
          + sx(2)*eyg(j+2,k0+2,l+2))*sy0(2)
      ey(nn) = ey(nn) + a*sz(2)
      ...
      a = a + (sx(-1)*ezg(j-1,k+2,l0+1) &
          ...
          + sx(2)*ezg(j+2,k+2,l0+1))*sy(2)
      ez(nn) = ez(nn) + a*sz0(1)
      a = (sx(-1)*ezg(j-1,k-1,l0+2) &
          + sx(0)*ezg(j,k-1,l0+2) &
          + sx(1)*ezg(j+1,k-1,l0+2) &
          + sx(2)*ezg(j+2,k-1,l0+2))*sy(-1)
      a = a + (sx(-1)*ezg(j-1,k,l0+2) &
          + sx(0)*ezg(j,k,l0+2) &
          + sx(1)*ezg(j+1,k,l0+2) &
          + sx(2)*ezg(j+2,k,l0+2))*sy(0)
      a = a + (sx(-1)*ezg(j-1,k+1,l0+2) &
          + sx(0)*ezg(j,k+1,l0+2) &
          + sx(1)*ezg(j+1,k+1,l0+2) &
          + sx(2)*ezg(j+2,k+1,l0+2))*sy(1)
      a = a + (sx(-1)*ezg(j-1,k+2,l0+2) &
          + sx(0)*ezg(j,k+2,l0+2) &
          + sx(1)*ezg(j+1,k+2,l0+2) &
          + sx(2)*ezg(j+2,k+2,l0+2))*sy(2)
      ez(nn) = ez(nn) + a*sz0(2)
      ...
      a = a + (sx(-1)*bxg(j-1,k0+1,l0-1) &
          ...
          + sx(1)*bxg(j+1,k0+1,l0-1) &
          + sx(2)*bxg(j+2,k0+1,l0-1))*sy0(1)
      a = a + (sx(-1)*bxg(j-1,k0+2,l0-1) &
          + sx(0)*bxg(j,k0+2,l0-1) &
          + sx(1)*bxg(j+1,k0+2,l0-1) &
          + sx(2)*bxg(j+2,k0+2,l0-1))*sy0(2)
      bx(nn) = bx(nn) + a*sz0(-1)
      a = (sx(-1)*bxg(j-1,k0-1,l0) &
          + sx(0)*bxg(j,k0-1,l0) &
          + sx(1)*bxg(j+1,k0-1,l0) &
      ...
      a = a + (sx(-1)*bxg(j-1,k0+1,l0) &
          ...
          + sx(1)*bxg(j+1,k0+1,l0) &
          + sx(2)*bxg(j+2,k0+1,l0))*sy0(1)
      a = a + (sx(-1)*bxg(j-1,k0+2,l0) &
          + sx(0)*bxg(j,k0+2,l0) &
          + sx(1)*bxg(j+1,k0+2,l0) &
          + sx(2)*bxg(j+2,k0+2,l0))*sy0(2)
      bx(nn) = bx(nn) + a*sz0(0)
      a = (sx(-1)*bxg(j-1,k0-1,l0+1) &
          + sx(0)*bxg(j,k0-1,l0+1) &
          + sx(1)*bxg(j+1,k0-1,l0+1) &
      ...
      a = a + (sx(-1)*bxg(j-1,k0+2,l0+1) &
          ...
          + sx(2)*bxg(j+2,k0+2,l0+1))*sy0(2)
      bx(nn) = bx(nn) + a*sz0(1)
      a = (sx(-1)*bxg(j-1,k0-1,l0+2) &
          + sx(0)*bxg(j,k0-1,l0+2) &
          + sx(1)*bxg(j+1,k0-1,l0+2) &
          + sx(2)*bxg(j+2,k0-1,l0+2))*sy0(-1)
      a = a + (sx(-1)*bxg(j-1,k0,l0+2) &
          + sx(0)*bxg(j,k0,l0+2) &
          + sx(1)*bxg(j+1,k0,l0+2) &
          + sx(2)*bxg(j+2,k0,l0+2))*sy0(0)
      a = a + (sx(-1)*bxg(j-1,k0+1,l0+2) &
          + sx(0)*bxg(j,k0+1,l0+2) &
          + sx(1)*bxg(j+1,k0+1,l0+2) &
          + sx(2)*bxg(j+2,k0+1,l0+2))*sy0(1)
      a = a + (sx(-1)*bxg(j-1,k0+2,l0+2) &
          + sx(0)*bxg(j,k0+2,l0+2) &
          + sx(1)*bxg(j+1,k0+2,l0+2) &
          + sx(2)*bxg(j+2,k0+2,l0+2))*sy0(2)
      bx(nn) = bx(nn) + a*sz0(2)

      ! Compute By on particle
      a = (sx0(-1)*byg(j0-1,k-1,l0-1) &
          + sx0(0)*byg(j0,k-1,l0-1) &
          + sx0(1)*byg(j0+1,k-1,l0-1) &
          + sx0(2)*byg(j0+2,k-1,l0-1))*sy(-1)
      a = a + (sx0(-1)*byg(j0-1,k,l0-1) &
          + sx0(0)*byg(j0,k,l0-1) &
          + sx0(1)*byg(j0+1,k,l0-1) &
          + sx0(2)*byg(j0+2,k,l0-1))*sy(0)
      a = a + (sx0(-1)*byg(j0-1,k+1,l0-1) &
          + sx0(0)*byg(j0,k+1,l0-1) &
          + sx0(1)*byg(j0+1,k+1,l0-1) &
          + sx0(2)*byg(j0+2,k+1,l0-1))*sy(1)
      a = a + (sx0(-1)*byg(j0-1,k+2,l0-1) &
          + sx0(0)*byg(j0,k+2,l0-1) &
          + sx0(1)*byg(j0+1,k+2,l0-1) &
          + sx0(2)*byg(j0+2,k+2,l0-1))*sy(2)
      by(nn) = by(nn) + a*sz0(-1)
      a = (sx0(-1)*byg(j0-1,k-1,l0) &
          + sx0(0)*byg(j0,k-1,l0) &
          + sx0(1)*byg(j0+1,k-1,l0) &
          + sx0(2)*byg(j0+2,k-1,l0))*sy(-1)
      a = a + (sx0(-1)*byg(j0-1,k,l0) &
          + sx0(0)*byg(j0,k,l0) &
          + sx0(1)*byg(j0+1,k,l0) &
          + sx0(2)*byg(j0+2,k,l0))*sy(0)
      a = a + (sx0(-1)*byg(j0-1,k+1,l0) &
          + sx0(0)*byg(j0,k+1,l0) &
          + sx0(1)*byg(j0+1,k+1,l0) &
          + sx0(2)*byg(j0+2,k+1,l0))*sy(1)
      a = a + (sx0(-1)*byg(j0-1,k+2,l0) &
          + sx0(0)*byg(j0,k+2,l0) &
          + sx0(1)*byg(j0+1,k+2,l0) &
          + sx0(2)*byg(j0+2,k+2,l0))*sy(2)
      by(nn) = by(nn) + a*sz0(0)
      a = (sx0(-1)*byg(j0-1,k-1,l0+1) &
          + sx0(0)*byg(j0,k-1,l0+1) &
          + sx0(1)*byg(j0+1,k-1,l0+1) &
      ...
      a = a + (sx0(-1)*byg(j0-1,k+2,l0+1) &
          ...
          + sx0(2)*byg(j0+2,k+2,l0+1))*sy(2)
      by(nn) = by(nn) + a*sz0(1)
      a = (sx0(-1)*byg(j0-1,k-1,l0+2) &
          + sx0(0)*byg(j0,k-1,l0+2) &
          + sx0(1)*byg(j0+1,k-1,l0+2) &
          + sx0(2)*byg(j0+2,k-1,l0+2))*sy(-1)
      a = a + (sx0(-1)*byg(j0-1,k,l0+2) &
          + sx0(0)*byg(j0,k,l0+2) &
          + sx0(1)*byg(j0+1,k,l0+2) &
          + sx0(2)*byg(j0+2,k,l0+2))*sy(0)
      a = a + (sx0(-1)*byg(j0-1,k+1,l0+2) &
          + sx0(0)*byg(j0,k+1,l0+2) &
          + sx0(1)*byg(j0+1,k+1,l0+2) &
          + sx0(2)*byg(j0+2,k+1,l0+2))*sy(1)
      a = a + (sx0(-1)*byg(j0-1,k+2,l0+2) &
          + sx0(0)*byg(j0,k+2,l0+2) &
          + sx0(1)*byg(j0+1,k+2,l0+2) &
          + sx0(2)*byg(j0+2,k+2,l0+2))*sy(2)
      by(nn) = by(nn) + a*sz0(2)

      ! Compute Bz on particle
      a = (sx0(-1)*bzg(j0-1,k0-1,l-1) &
          + sx0(0)*bzg(j0,k0-1,l-1) &
          + sx0(1)*bzg(j0+1,k0-1,l-1) &
          + sx0(2)*bzg(j0+2,k0-1,l-1))*sy0(-1)
      a = a + (sx0(-1)*bzg(j0-1,k0,l-1) &
          + sx0(0)*bzg(j0,k0,l-1) &
          + sx0(1)*bzg(j0+1,k0,l-1) &
          + sx0(2)*bzg(j0+2,k0,l-1))*sy0(0)
      a = a + (sx0(-1)*bzg(j0-1,k0+1,l-1) &
          + sx0(0)*bzg(j0,k0+1,l-1) &
          + sx0(1)*bzg(j0+1,k0+1,l-1) &
          + sx0(2)*bzg(j0+2,k0+1,l-1))*sy0(1)
      a = a + (sx0(-1)*bzg(j0-1,k0+2,l-1) &
          + sx0(0)*bzg(j0,k0+2,l-1) &
          + sx0(1)*bzg(j0+1,k0+2,l-1) &
          + sx0(2)*bzg(j0+2,k0+2,l-1))*sy0(2)
      bz(nn) = bz(nn) + a*sz(-1)
      a = (sx0(-1)*bzg(j0-1,k0-1,l) &
          + sx0(0)*bzg(j0,k0-1,l) &
          + sx0(1)*bzg(j0+1,k0-1,l) &
          + sx0(2)*bzg(j0+2,k0-1,l))*sy0(-1)
      a = a + (sx0(-1)*bzg(j0-1,k0,l) &
          + sx0(0)*bzg(j0,k0,l) &
          + sx0(1)*bzg(j0+1,k0,l) &
          + sx0(2)*bzg(j0+2,k0,l))*sy0(0)
      a = a + (sx0(-1)*bzg(j0-1,k0+1,l) &
          + sx0(0)*bzg(j0,k0+1,l) &
          + sx0(1)*bzg(j0+1,k0+1,l) &
          + sx0(2)*bzg(j0+2,k0+1,l))*sy0(1)
      a = a + (sx0(-1)*bzg(j0-1,k0+2,l) &
          + sx0(0)*bzg(j0,k0+2,l) &
          + sx0(1)*bzg(j0+1,k0+2,l) &
          + sx0(2)*bzg(j0+2,k0+2,l))*sy0(2)
      bz(nn) = bz(nn) + a*sz(0)
      a = (sx0(-1)*bzg(j0-1,k0-1,l+1) &
          + sx0(0)*bzg(j0,k0-1,l+1) &
          + sx0(1)*bzg(j0+1,k0-1,l+1) &
      ...
      a = (sx0(-1)*bzg(j0-1,k0-1,l+2) &
          + sx0(0)*bzg(j0,k0-1,l+2) &
          + sx0(1)*bzg(j0+1,k0-1,l+2) &
          + sx0(2)*bzg(j0+2,k0-1,l+2))*sy0(-1)
      a = a + (sx0(-1)*bzg(j0-1,k0,l+2) &
          + sx0(0)*bzg(j0,k0,l+2) &
          + sx0(1)*bzg(j0+1,k0,l+2) &
          + sx0(2)*bzg(j0+2,k0,l+2))*sy0(0)
      a = a + (sx0(-1)*bzg(j0-1,k0+1,l+2) &
          + sx0(0)*bzg(j0,k0+1,l+2) &
          + sx0(1)*bzg(j0+1,k0+1,l+2) &
          + sx0(2)*bzg(j0+2,k0+1,l+2))*sy0(1)
      a = a + (sx0(-1)*bzg(j0-1,k0+2,l+2) &
          + sx0(0)*bzg(j0,k0+2,l+2) &
          + sx0(1)*bzg(j0+1,k0+2,l+2) &
          + sx0(2)*bzg(j0+2,k0+2,l+2))*sy0(2)
      bz(nn) = bz(nn) + a*sz(2)
...
!!DIR DISTRIBUTE POINT
    ...
    DO n=1,MIN(lvect,np-ip+1)
      ...
      ! Compute Ex on particle
      a = (sx0(n,-1)*exg(j0(n)-1,k(n)-1,l(n)-1) &
          + sx0(n,0)*exg(j0(n),k(n)-1,l(n)-1) &
          + sx0(n,1)*exg(j0(n)+1,k(n)-1,l(n)-1))*sy(n,-1)
      a = a + (sx0(n,-1)*exg(j0(n)-1,k(n),l(n)-1) &
          + sx0(n,0)*exg(j0(n),k(n),l(n)-1) &
          + sx0(n,1)*exg(j0(n)+1,k(n),l(n)-1))*sy(n,0)
      a = a + (sx0(n,-1)*exg(j0(n)-1,k(n)+1,l(n)-1) &
          + sx0(n,0)*exg(j0(n),k(n)+1,l(n)-1) &
          + sx0(n,1)*exg(j0(n)+1,k(n)+1,l(n)-1))*sy(n,1)
      a = a + (sx0(n,-1)*exg(j0(n)-1,k(n)+2,l(n)-1) &
          + sx0(n,0)*exg(j0(n),k(n)+2,l(n)-1) &
          + sx0(n,1)*exg(j0(n)+1,k(n)+2,l(n)-1))*sy(n,2)
      ex(nn) = ex(nn) + a*sz(n,-1)
      a = (sx0(n,-1)*exg(j0(n)-1,k(n)-1,l(n)) &
          + sx0(n,0)*exg(j0(n),k(n)-1,l(n)) &
          + sx0(n,1)*exg(j0(n)+1,k(n)-1,l(n)))*sy(n,-1)
      a = a + (sx0(n,-1)*exg(j0(n)-1,k(n),l(n)) &
          + sx0(n,0)*exg(j0(n),k(n),l(n)) &
          + sx0(n,1)*exg(j0(n)+1,k(n),l(n)))*sy(n,0)
      a = a + (sx0(n,-1)*exg(j0(n)-1,k(n)+1,l(n)) &
          + sx0(n,0)*exg(j0(n),k(n)+1,l(n)) &
          + sx0(n,1)*exg(j0(n)+1,k(n)+1,l(n)))*sy(n,1)
      a = a + (sx0(n,-1)*exg(j0(n)-1,k(n)+2,l(n)) &
          + sx0(n,0)*exg(j0(n),k(n)+2,l(n)) &
          + sx0(n,1)*exg(j0(n)+1,k(n)+2,l(n)))*sy(n,2)
      ex(nn) = ex(nn) + a*sz(n,0)
      a = (sx0(n,-1)*exg(j0(n)-1,k(n)-1,l(n)+1) &
          + sx0(n,0)*exg(j0(n),k(n)-1,l(n)+1) &
          + sx0(n,1)*exg(j0(n)+1,k(n)-1,l(n)+1))*sy(n,-1)
      ...
      a = a + (sx0(n,-1)*exg(j0(n)-1,k(n)+2,l(n)+1) &
          ...
          + sx0(n,1)*exg(j0(n)+1,k(n)+2,l(n)+1))*sy(n,2)
      ex(nn) = ex(nn) + a*sz(n,1)
      a = (sx0(n,-1)*exg(j0(n)-1,k(n)-1,l(n)+2) &
          + sx0(n,0)*exg(j0(n),k(n)-1,l(n)+2) &
          + sx0(n,1)*exg(j0(n)+1,k(n)-1,l(n)+2))*sy(n,-1)
      a = a + (sx0(n,-1)*exg(j0(n)-1,k(n),l(n)+2) &
          + sx0(n,0)*exg(j0(n),k(n),l(n)+2) &
          + sx0(n,1)*exg(j0(n)+1,k(n),l(n)+2))*sy(n,0)
      a = a + (sx0(n,-1)*exg(j0(n)-1,k(n)+1,l(n)+2) &
          + sx0(n,0)*exg(j0(n),k(n)+1,l(n)+2) &
          + sx0(n,1)*exg(j0(n)+1,k(n)+1,l(n)+2))*sy(n,1)
      a = a + (sx0(n,-1)*exg(j0(n)-1,k(n)+2,l(n)+2) &
          + sx0(n,0)*exg(j0(n),k(n)+2,l(n)+2) &
          + sx0(n,1)*exg(j0(n)+1,k(n)+2,l(n)+2))*sy(n,2)
      ex(nn) = ex(nn) + a*sz(n,2)
...
!!DIR DISTRIBUTE POINT
    ...
    DO n=1,MIN(lvect,np-ip+1)
      ...
      ! Compute Ey on particle
      a = (sx(n,-1)*eyg(j(n)-1,k0(n)-1,l(n)-1) &
          + sx(n,0)*eyg(j(n),k0(n)-1,l(n)-1) &
          + sx(n,1)*eyg(j(n)+1,k0(n)-1,l(n)-1) &
          + sx(n,2)*eyg(j(n)+2,k0(n)-1,l(n)-1))*sy0(n,-1)
      a = a + (sx(n,-1)*eyg(j(n)-1,k0(n),l(n)-1) &
          + sx(n,0)*eyg(j(n),k0(n),l(n)-1) &
          + sx(n,1)*eyg(j(n)+1,k0(n),l(n)-1) &
          + sx(n,2)*eyg(j(n)+2,k0(n),l(n)-1))*sy0(n,0)
      a = a + (sx(n,-1)*eyg(j(n)-1,k0(n)+1,l(n)-1) &
          + sx(n,0)*eyg(j(n),k0(n)+1,l(n)-1) &
          + sx(n,1)*eyg(j(n)+1,k0(n)+1,l(n)-1) &
          + sx(n,2)*eyg(j(n)+2,k0(n)+1,l(n)-1))*sy0(n,1)
      ey(nn) = ey(nn) + a*sz(n,-1)
      a = (sx(n,-1)*eyg(j(n)-1,k0(n)-1,l(n)) &
          + sx(n,0)*eyg(j(n),k0(n)-1,l(n)) &
          + sx(n,1)*eyg(j(n)+1,k0(n)-1,l(n)) &
          + sx(n,2)*eyg(j(n)+2,k0(n)-1,l(n)))*sy0(n,-1)
      a = a + (sx(n,-1)*eyg(j(n)-1,k0(n),l(n)) &
          + sx(n,0)*eyg(j(n),k0(n),l(n)) &
          + sx(n,1)*eyg(j(n)+1,k0(n),l(n)) &
          + sx(n,2)*eyg(j(n)+2,k0(n),l(n)))*sy0(n,0)
      a = a + (sx(n,-1)*eyg(j(n)-1,k0(n)+1,l(n)) &
          + sx(n,0)*eyg(j(n),k0(n)+1,l(n)) &
          + sx(n,1)*eyg(j(n)+1,k0(n)+1,l(n)) &
          + sx(n,2)*eyg(j(n)+2,k0(n)+1,l(n)))*sy0(n,1)
      ey(nn) = ey(nn) + a*sz(n,0)
      ...
      a = a + (sx(n,-1)*eyg(j(n)-1,k0(n)+1,l(n)+1) &
          ...
          + sx(n,2)*eyg(j(n)+2,k0(n)+1,l(n)+1))*sy0(n,1)
      ey(nn) = ey(nn) + a*sz(n,1)
      a = (sx(n,-1)*eyg(j(n)-1,k0(n)-1,l(n)+2) &
          + sx(n,0)*eyg(j(n),k0(n)-1,l(n)+2) &
          + sx(n,1)*eyg(j(n)+1,k0(n)-1,l(n)+2) &
          + sx(n,2)*eyg(j(n)+2,k0(n)-1,l(n)+2))*sy0(n,-1)
      a = a + (sx(n,-1)*eyg(j(n)-1,k0(n),l(n)+2) &
          + sx(n,0)*eyg(j(n),k0(n),l(n)+2) &
          + sx(n,1)*eyg(j(n)+1,k0(n),l(n)+2) &
          + sx(n,2)*eyg(j(n)+2,k0(n),l(n)+2))*sy0(n,0)
      a = a + (sx(n,-1)*eyg(j(n)-1,k0(n)+1,l(n)+2) &
          + sx(n,0)*eyg(j(n),k0(n)+1,l(n)+2) &
          + sx(n,1)*eyg(j(n)+1,k0(n)+1,l(n)+2) &
          + sx(n,2)*eyg(j(n)+2,k0(n)+1,l(n)+2))*sy0(n,1)
      ey(nn) = ey(nn) + a*sz(n,2)
...
!!DIR DISTRIBUTE POINT
    ...
    DO n=1,MIN(lvect,np-ip+1)
      ...
      ! Compute Ez on particle
      a = (sx(n,-1)*ezg(j(n)-1,k(n)-1,l0(n)-1) &
          + sx(n,0)*ezg(j(n),k(n)-1,l0(n)-1) &
          + sx(n,1)*ezg(j(n)+1,k(n)-1,l0(n)-1) &
          + sx(n,2)*ezg(j(n)+2,k(n)-1,l0(n)-1))*sy(n,-1)
      a = a + (sx(n,-1)*ezg(j(n)-1,k(n),l0(n)-1) &
          + sx(n,0)*ezg(j(n),k(n),l0(n)-1) &
          + sx(n,1)*ezg(j(n)+1,k(n),l0(n)-1) &
          + sx(n,2)*ezg(j(n)+2,k(n),l0(n)-1))*sy(n,0)
      a = a + (sx(n,-1)*ezg(j(n)-1,k(n)+1,l0(n)-1) &
          + sx(n,0)*ezg(j(n),k(n)+1,l0(n)-1) &
          + sx(n,1)*ezg(j(n)+1,k(n)+1,l0(n)-1) &
          + sx(n,2)*ezg(j(n)+2,k(n)+1,l0(n)-1))*sy(n,1)
      a = a + (sx(n,-1)*ezg(j(n)-1,k(n)+2,l0(n)-1) &
          + sx(n,0)*ezg(j(n),k(n)+2,l0(n)-1) &
          + sx(n,1)*ezg(j(n)+1,k(n)+2,l0(n)-1) &
          + sx(n,2)*ezg(j(n)+2,k(n)+2,l0(n)-1))*sy(n,2)
      ez(nn) = ez(nn) + a*sz0(n,-1)
      a = (sx(n,-1)*ezg(j(n)-1,k(n)-1,l0(n)) &
          + sx(n,0)*ezg(j(n),k(n)-1,l0(n)) &
          + sx(n,1)*ezg(j(n)+1,k(n)-1,l0(n)) &
          + sx(n,2)*ezg(j(n)+2,k(n)-1,l0(n)))*sy(n,-1)
      a = a + (sx(n,-1)*ezg(j(n)-1,k(n),l0(n)) &
          + sx(n,0)*ezg(j(n),k(n),l0(n)) &
          + sx(n,1)*ezg(j(n)+1,k(n),l0(n)) &
          + sx(n,2)*ezg(j(n)+2,k(n),l0(n)))*sy(n,0)
      a = a + (sx(n,-1)*ezg(j(n)-1,k(n)+1,l0(n)) &
          + sx(n,0)*ezg(j(n),k(n)+1,l0(n)) &
          + sx(n,1)*ezg(j(n)+1,k(n)+1,l0(n)) &
          + sx(n,2)*ezg(j(n)+2,k(n)+1,l0(n)))*sy(n,1)
      a = a + (sx(n,-1)*ezg(j(n)-1,k(n)+2,l0(n)) &
          + sx(n,0)*ezg(j(n),k(n)+2,l0(n)) &
          + sx(n,1)*ezg(j(n)+1,k(n)+2,l0(n)) &
          + sx(n,2)*ezg(j(n)+2,k(n)+2,l0(n)))*sy(n,2)
      ez(nn) = ez(nn) + a*sz0(n,0)
      a = (sx(n,-1)*ezg(j(n)-1,k(n)-1,l0(n)+1) &
          + sx(n,0)*ezg(j(n),k(n)-1,l0(n)+1) &
          + sx(n,1)*ezg(j(n)+1,k(n)-1,l0(n)+1) &
...
!!DIR DISTRIBUTE POINT
    ...
    DO n=1,MIN(lvect,np-ip+1)
      ...
      ! Compute Bx on particle
      a = (sx(n,-1)*bxg(j(n)-1,k0(n)-1,l0(n)-1) &
          + sx(n,0)*bxg(j(n),k0(n)-1,l0(n)-1) &
          + sx(n,1)*bxg(j(n)+1,k0(n)-1,l0(n)-1) &
          + sx(n,2)*bxg(j(n)+2,k0(n)-1,l0(n)-1))*sy0(n,-1)
      a = a + (sx(n,-1)*bxg(j(n)-1,k0(n),l0(n)-1) &
          + sx(n,0)*bxg(j(n),k0(n),l0(n)-1) &
          + sx(n,1)*bxg(j(n)+1,k0(n),l0(n)-1) &
          + sx(n,2)*bxg(j(n)+2,k0(n),l0(n)-1))*sy0(n,0)
      a = a + (sx(n,-1)*bxg(j(n)-1,k0(n)+1,l0(n)-1) &
          + sx(n,0)*bxg(j(n),k0(n)+1,l0(n)-1) &
          + sx(n,1)*bxg(j(n)+1,k0(n)+1,l0(n)-1) &
          + sx(n,2)*bxg(j(n)+2,k0(n)+1,l0(n)-1))*sy0(n,1)
      bx(nn) = bx(nn) + a*sz0(n,-1)
      a = (sx(n,-1)*bxg(j(n)-1,k0(n)-1,l0(n)) &
          + sx(n,0)*bxg(j(n),k0(n)-1,l0(n)) &
          + sx(n,1)*bxg(j(n)+1,k0(n)-1,l0(n)) &
          + sx(n,2)*bxg(j(n)+2,k0(n)-1,l0(n)))*sy0(n,-1)
      a = a + (sx(n,-1)*bxg(j(n)-1,k0(n),l0(n)) &
          + sx(n,0)*bxg(j(n),k0(n),l0(n)) &
          + sx(n,1)*bxg(j(n)+1,k0(n),l0(n)) &
          + sx(n,2)*bxg(j(n)+2,k0(n),l0(n)))*sy0(n,0)
      a = a + (sx(n,-1)*bxg(j(n)-1,k0(n)+1,l0(n)) &
          + sx(n,0)*bxg(j(n),k0(n)+1,l0(n)) &
          + sx(n,1)*bxg(j(n)+1,k0(n)+1,l0(n)) &
          + sx(n,2)*bxg(j(n)+2,k0(n)+1,l0(n)))*sy0(n,1)
      bx(nn) = bx(nn) + a*sz0(n,0)
...
!!DIR DISTRIBUTE POINT
    ...
    DO n=1,MIN(lvect,np-ip+1)
      ...
      ! Compute By on particle
      a = (sx0(n,-1)*byg(j0(n)-1,k(n)-1,l0(n)-1) &
          + sx0(n,0)*byg(j0(n),k(n)-1,l0(n)-1) &
          + sx0(n,1)*byg(j0(n)+1,k(n)-1,l0(n)-1))*sy(n,-1)
      a = a + (sx0(n,-1)*byg(j0(n)-1,k(n),l0(n)-1) &
          + sx0(n,0)*byg(j0(n),k(n),l0(n)-1) &
          + sx0(n,1)*byg(j0(n)+1,k(n),l0(n)-1))*sy(n,0)
      a = a + (sx0(n,-1)*byg(j0(n)-1,k(n)+1,l0(n)-1) &
          + sx0(n,0)*byg(j0(n),k(n)+1,l0(n)-1) &
          + sx0(n,1)*byg(j0(n)+1,k(n)+1,l0(n)-1))*sy(n,1)
      a = a + (sx0(n,-1)*byg(j0(n)-1,k(n)+2,l0(n)-1) &
          + sx0(n,0)*byg(j0(n),k(n)+2,l0(n)-1) &
          + sx0(n,1)*byg(j0(n)+1,k(n)+2,l0(n)-1))*sy(n,2)
      by(nn) = by(nn) + a*sz0(n,-1)
      a = (sx0(n,-1)*byg(j0(n)-1,k(n)-1,l0(n)) &
          + sx0(n,0)*byg(j0(n),k(n)-1,l0(n)) &
          + sx0(n,1)*byg(j0(n)+1,k(n)-1,l0(n)))*sy(n,-1)
      a = a + (sx0(n,-1)*byg(j0(n)-1,k(n),l0(n)) &
          + sx0(n,0)*byg(j0(n),k(n),l0(n)) &
          + sx0(n,1)*byg(j0(n)+1,k(n),l0(n)))*sy(n,0)
      a = a + (sx0(n,-1)*byg(j0(n)-1,k(n)+1,l0(n)) &
          + sx0(n,0)*byg(j0(n),k(n)+1,l0(n)) &
          + sx0(n,1)*byg(j0(n)+1,k(n)+1,l0(n)))*sy(n,1)
      a = a + (sx0(n,-1)*byg(j0(n)-1,k(n)+2,l0(n)) &
          + sx0(n,0)*byg(j0(n),k(n)+2,l0(n)) &
          + sx0(n,1)*byg(j0(n)+1,k(n)+2,l0(n)))*sy(n,2)
      by(nn) = by(nn) + a*sz0(n,0)
      a = (sx0(n,-1)*byg(j0(n)-1,k(n)-1,l0(n)+1) &
          + sx0(n,0)*byg(j0(n),k(n)-1,l0(n)+1) &
          + sx0(n,1)*byg(j0(n)+1,k(n)-1,l0(n)+1))*sy(n,-1)
...
!!DIR DISTRIBUTE POINT
    ...
    DO n=1,MIN(lvect,np-ip+1)
      ...
      ! Compute Bz on particle
      a = (sx0(n,-1)*bzg(j0(n)-1,k0(n)-1,l(n)-1) &
          + sx0(n,0)*bzg(j0(n),k0(n)-1,l(n)-1) &
          + sx0(n,1)*bzg(j0(n)+1,k0(n)-1,l(n)-1))*sy0(n,-1)
      a = a + (sx0(n,-1)*bzg(j0(n)-1,k0(n),l(n)-1) &
          + sx0(n,0)*bzg(j0(n),k0(n),l(n)-1) &
          + sx0(n,1)*bzg(j0(n)+1,k0(n),l(n)-1))*sy0(n,0)
      a = a + (sx0(n,-1)*bzg(j0(n)-1,k0(n)+1,l(n)-1) &
          + sx0(n,0)*bzg(j0(n),k0(n)+1,l(n)-1) &
          + sx0(n,1)*bzg(j0(n)+1,k0(n)+1,l(n)-1))*sy0(n,1)
      bz(nn) = bz(nn) + a*sz(n,-1)
      a = (sx0(n,-1)*bzg(j0(n)-1,k0(n)-1,l(n)) &
          + sx0(n,0)*bzg(j0(n),k0(n)-1,l(n)) &
          + sx0(n,1)*bzg(j0(n)+1,k0(n)-1,l(n)))*sy0(n,-1)
      a = a + (sx0(n,-1)*bzg(j0(n)-1,k0(n),l(n)) &
          + sx0(n,0)*bzg(j0(n),k0(n),l(n)) &
          + sx0(n,1)*bzg(j0(n)+1,k0(n),l(n)))*sy0(n,0)
      a = a + (sx0(n,-1)*bzg(j0(n)-1,k0(n)+1,l(n)) &
          + sx0(n,0)*bzg(j0(n),k0(n)+1,l(n)) &
          + sx0(n,1)*bzg(j0(n)+1,k0(n)+1,l(n)))*sy0(n,1)
      bz(nn) = bz(nn) + a*sz(n,0)
      a = (sx0(n,-1)*bzg(j0(n)-1,k0(n)-1,l(n)+1) &
      ...
      a = a + (sx0(n,-1)*bzg(j0(n)-1,k0(n)+1,l(n)+1) &
          ...
          + sx0(n,1)*bzg(j0(n)+1,k0(n)+1,l(n)+1))*sy0(n,1)
      bz(nn) = bz(nn) + a*sz(n,1)
      a = (sx0(n,-1)*bzg(j0(n)-1,k0(n)-1,l(n)+2) &
          + sx0(n,0)*bzg(j0(n),k0(n)-1,l(n)+2) &
          + sx0(n,1)*bzg(j0(n)+1,k0(n)-1,l(n)+2))*sy0(n,-1)
      a = a + (sx0(n,-1)*bzg(j0(n)-1,k0(n),l(n)+2) &
          + sx0(n,0)*bzg(j0(n),k0(n),l(n)+2) &
          + sx0(n,1)*bzg(j0(n)+1,k0(n),l(n)+2))*sy0(n,0)
      a = a + (sx0(n,-1)*bzg(j0(n)-1,k0(n)+1,l(n)+2) &
          + sx0(n,0)*bzg(j0(n),k0(n)+1,l(n)+2) &
          + sx0(n,1)*bzg(j0(n)+1,k0(n)+1,l(n)+2))*sy0(n,1)
      bz(nn) = bz(nn) + a*sz(n,2)
