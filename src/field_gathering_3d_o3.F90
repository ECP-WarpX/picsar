...
#if defined(DEV)
SUBROUTINE gete3d_energy_conserving_vect2_3_3_3(np,xp,yp,zp,ex,ey,ez,xmin,ymin,zmin,       &
                                      dx,dy,dz,nx,ny,nz,nxguard,nyguard,nzguard, &
                                      exg,eyg,ezg,lvect,l_lower_order_in_v)
! ________________________________________________________________________________________
...
RETURN
END SUBROUTINE gete3d_energy_conserving_vect2_3_3_3
#endif
...
! ________________________________________________________________________________________
!> @brief
!> Vectorized gathering of magnetic field (version 2) from Yee grid ("energy conserving") on particles
!> at order 3.
!
!> @details
!> 
...
!> @author
!> Mathieu Lobet
SUBROUTINE getb3d_energy_conserving_vect2_3_3_3(np,xp,yp,zp,bx,by,bz,xmin,ymin,zmin,       &
                                      dx,dy,dz,nx,ny,nz,nxguard,nyguard,nzguard, &
                                      bxg,byg,bzg,lvect,l_lower_order_in_v)
! ________________________________________________________________________________________
...
!!DIR DISTRIBUTE POINT
  ...
  ENDIF
  RETURN
END SUBROUTINE getb3d_energy_conserving_vect2_3_3_3
#endif
