...
MODULE fastfft
  ...
  SUBROUTINE fast_fftw_create_plan_3d_dft(nopenmp, nx, ny, nz, array_in, array_out,   &
    ...
    INTEGER(C_INT) :: iret, plan_type_cint, dir_cint, nx_cint, ny_cint, nz_cint,      &
    nopenmp_cint
    ...
    CALL  DFFTW_PLAN_DFT_3D(plans_cint(nplan), nx_cint, ny_cint, nz_cint, array_in,   &
    array_out, dir_cint, plan_type_cint)
  ...
  SUBROUTINE fast_fftw_create_plan_r2c_3d_dft(nopenmp, nx, ny, nz, array_in,          &
    ...
    INTEGER(idp), DIMENSION(1), INTENT(IN OUT) :: plan
    INTEGER(idp), INTENT(IN) :: plan_type, dir
    INTEGER(C_INT) :: iret, nopenmp_cint, nx_cint, ny_cint, nz_cint, plan_type_cint,  &
    dir_cint
    ...
    array_in, array_out, plan_type_cint, dir_cint)
    ! return index of plan
    plan(1)=nplan
  ...
  ! FFTW_MEASURE (moderate to high overhead, high optimization)
  ! FFTW_EXHAUSTIVE (very high overhead, brute force optimization)
  SUBROUTINE fast_fftw_create_plan_2d_dft(nopenmp, nx, nz, array_in, array_out, plan, &
    plan_type, dir)
    USE omp_lib
    USE fftw3_fortran
    ...
    INTEGER(idp), DIMENSION(1), INTENT(IN OUT) :: plan
    INTEGER(idp), INTENT(IN) :: plan_type, dir
    INTEGER(C_INT) :: iret, nopenmp_cint, nx_cint, nz_cint, plan_type_cint, dir_cint
    ...
    CALL  DFFTW_INIT_THREADS(iret)
    CALL  DFFTW_PLAN_WITH_NTHREADS(nopenmp_cint)
    CALL  DFFTW_PLAN_DFT_2D(plans_cint(nplan), nx_cint, nz_cint, array_in, array_out, &
  ...
  ! FFTW_MEASURE (moderate to high overhead, high optimization)
  ! FFTW_EXHAUSTIVE (very high overhead, brute force optimization)
  SUBROUTINE fast_fftw_create_plan_r2c_2d_dft(nopenmp, nx, nz, array_in, array_out,   &
    plan, plan_type, dir)
    USE omp_lib
    USE fftw3_fortran
    INTEGER(idp), INTENT(IN) ::  nopenmp, nx, nz
    ...
    array_out, plan_type_cint, dir_cint)
    ! return index of plan
    plan(1)=nplan
  ...
  ! FFTW_MEASURE (moderate to high overhead, high optimization)
  ! FFTW_EXHAUSTIVE (very high overhead, brute force optimization)
  SUBROUTINE fast_fftw_create_plan_c2r_2d_dft(nopenmp, nx, nz, array_in, array_out,   &
    plan, plan_type, dir)
    USE omp_lib
    USE fftw3_fortran
    INTEGER(idp), INTENT(IN) ::  nopenmp, nx, nz
  ...
  ! FFTW_MEASURE (moderate to high overhead, high optimization)
  ! FFTW_EXHAUSTIVE (very high overhead, brute force optimization)
  SUBROUTINE fast_fftw_create_plan_1d_dft(nopenmp, nx, array_in, array_out, plan,     &
    plan_type, dir)
    USE omp_lib
    USE fftw3_fortran
    ...
    INTEGER(idp), DIMENSION(1), INTENT(IN OUT) :: plan
    INTEGER(idp), INTENT(IN) :: plan_type, dir
    INTEGER(C_INT) :: iret, nopenmp_cint, nx_cint, plan_type_cint, dir_cint
  ...
  ! FFTW_MEASURE (moderate to high overhead, high optimization)
  ! FFTW_EXHAUSTIVE (very high overhead, brute force optimization)
  SUBROUTINE fast_fftw_create_plan_r2c_1d_dft(nopenmp, nx, array_in, array_out, plan, &
    plan_type, dir)
    USE omp_lib
    USE fftw3_fortran
    INTEGER(idp), INTENT(IN) ::  nopenmp, nx
  ...
  ! FFTW_MEASURE (moderate to high overhead, high optimization)
  ! FFTW_EXHAUSTIVE (very high overhead, brute force optimization)
  SUBROUTINE fast_fftw_create_plan_c2r_1d_dft(nopenmp, nx, array_in, array_out, plan, &
    plan_type, dir)
    USE omp_lib
    USE fftw3_fortran
    INTEGER(idp), INTENT(IN) ::  nopenmp, nx
    ...
    CALL  DFFTW_INIT_THREADS(iret)
    CALL  DFFTW_PLAN_WITH_NTHREADS(nopenmp_cint)
    CALL  DFFTW_PLAN_DFT_C2R_1D(plans_cint(nplan), nx_cint, array_in, array_out,      &
    plan_type_cint, dir_cint)
    ! return index of plan
    plan(1)=nplan
