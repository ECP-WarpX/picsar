...
! (i)  Fourier init (allocation and init of Fourier k-vectors, ! creation of planes for FFTW etc.), ! (ii) Forward/Backward Fourier transform of EM fields using, ! FFTW (Distributed/Shared version), ! (iii) Maxwell push in the spectral space using the Pseudo-Spectral Arbitrary Order
