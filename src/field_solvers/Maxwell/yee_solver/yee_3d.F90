...
! and the generalization at order n in 3D.
!
! Authors:
! Henri Vincenti
! Mathieu Lobet
...
!> @date
!> Creation 2015
subroutine warpx_pxr_push_em3d_evec_norder( &
...
! ______________________________________________________________________________
  ...
  ! advance Ex, Ey and Ez in the same loops
  do l = zlo, zhi
      do k = ylo, yhi
          do j = xlo, xhi
  ...
  return
end subroutine warpx_pxr_push_em3d_evec_norder
