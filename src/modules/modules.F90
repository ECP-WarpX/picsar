...
MODULE fields
  ...
  !> MPI-domain electric field grid in x (auxiliary array for gather to
  !particles)
  REAL(num), POINTER, DIMENSION(:, :, :) :: ex_p
  !> MPI-domain electric field grid in y (auxiliary array for gather to
  !particles)
  REAL(num), POINTER, DIMENSION(:, :, :) :: ey_p
  !> MPI-domain electric field grid in z (auxiliary array for gather to
  !particles)
  REAL(num), POINTER, DIMENSION(:, :, :) :: ez_p
  !> MPI-domain magnetic field grid in x (auxiliary array for gather to
  !particles)
  REAL(num), POINTER, DIMENSION(:, :, :) :: bx_p
  !> MPI-domain magnetic field grid in y (auxiliary array for gather to
  !particles)
  REAL(num), POINTER, DIMENSION(:, :, :) :: by_p
  !> MPI-domain magnetic field grid in z (auxiliary array for gather to
  !particles)
  ...
  REAL(num), POINTER, DIMENSION(:, :, :) :: Vphi,Vphi_r,Vphif
