...
filename="gathering_routines_blockvect2_"+str(nox)+"_"+str(noy)+"_"+str(noz)+".F90"
subroutine_b_field="getb3d_energy_conserving_blockvect2_"+str(nox)+"_"+str(noy)+"_"+str(noz)
subroutine_e_field="gete3d_energy_conserving_blockvect2_"+str(nox)+"_"+str(noy)+"_"+str(noz)
indent_cont_1="                                      "
indent_cont_2="              "
indent_1="  "
...
for ll in range(izmin0, izmax0+1):
    for kk in range(iymin0, iymax0+1):
        ...
        for jj in range(ixmin, ixmax+2):
            if (jj==ixmin):
              fh.write("sx(n,"+str(jj)+")*bxg(j(n)"+plusi(jj)+",k0(n)"+plusi(kk)+",l0(n)"+plusi(ll)+") &\n");
            elif (jj==ixmax+1):
              fh.write(indent_2+"    + sx(n,"+str(jj)+")*bxg(j(n)"+plusi(jj)+",k0(n)"+plusi(kk)+",l0(n)"+plusi(ll)+"))");
            else:
              fh.write(indent_2+"    + sx(n,"+str(jj)+")*bxg(j(n)"+plusi(jj)+",k0(n)"+plusi(kk)+",l0(n)"+plusi(ll)+") &\n"); 
        fh.write("*sy0(n,"+str(kk)+")\n")
    fh.write(indent_2+"bx(nn) = bx(nn) + a*sz0(n,"+str(ll)+")\n")
...
for ll in range(izmin0, izmax0+1):
    for kk in range(iymin, iymax+2):
        ...
        for jj in range(ixmin0, ixmax0+1):
            if (jj==ixmin0):
              fh.write("sx0(n,"+str(jj)+")*byg(j0(n)"+plusi(jj)+",k(n)"+plusi(kk)+",l0(n)"+plusi(ll)+") &\n");
            elif (jj==ixmax0):
              fh.write(indent_2+"    + sx0(n,"+str(jj)+")*byg(j0(n)"+plusi(jj)+",k(n)"+plusi(kk)+",l0(n)"+plusi(ll)+"))");
            else:
              fh.write(indent_2+"    + sx0(n,"+str(jj)+")*byg(j0(n)"+plusi(jj)+",k(n)"+plusi(kk)+",l0(n)"+plusi(ll)+") &\n"); 
        fh.write("*sy(n,"+str(kk)+")\n")
    fh.write(indent_2+"by(nn) = by(nn) + a*sz0(n,"+str(ll)+")\n")
...
for ll in range(izmin, izmax+2):
    for kk in range(iymin0, iymax0+1):
        ...
        for jj in range(ixmin0, ixmax0+1):
            if (jj==ixmin0):
              fh.write("sx0(n,"+str(jj)+")*bzg(j0(n)"+plusi(jj)+",k0(n)"+plusi(kk)+",l(n)"+plusi(ll)+") &\n");
            elif (jj==ixmax0):
              fh.write(indent_2+"    + sx0(n,"+str(jj)+")*bzg(j0(n)"+plusi(jj)+",k0(n)"+plusi(kk)+",l(n)"+plusi(ll)+"))");
            else:
              fh.write(indent_2+"    + sx0(n,"+str(jj)+")*bzg(j0(n)"+plusi(jj)+",k0(n)"+plusi(kk)+",l(n)"+plusi(ll)+") &\n");
        fh.write("*sy0(n,"+str(kk)+")\n")
    fh.write(indent_2+"bz(nn) = bz(nn) + a*sz(n,"+str(ll)+")\n")
...
for ll in range(izmin, izmax+2):
    for kk in range(iymin, iymax+2):
        ...
        for jj in range(ixmin0, ixmax0+1):
            if (jj==ixmin0):
              fh.write("sx0(n,"+str(jj)+")*exg(j0(n)"+plusi(jj)+",k(n)"+plusi(kk)+",l(n)"+plusi(ll)+") &\n");
            elif (jj==ixmax0):
              fh.write(indent_2+"    + sx0(n,"+str(jj)+")*exg(j0(n)"+plusi(jj)+",k(n)"+plusi(kk)+",l(n)"+plusi(ll)+"))");
            else:
              fh.write(indent_2+"    + sx0(n,"+str(jj)+")*exg(j0(n)"+plusi(jj)+",k(n)"+plusi(kk)+",l(n)"+plusi(ll)+") &\n");
        fh.write("*sy(n,"+str(kk)+")\n")
    fh.write(indent_2+"ex(nn) = ex(nn) + a*sz(n,"+str(ll)+")\n")
...
for ll in range(izmin, izmax+2):
    for kk in range(iymin0, iymax0+1):
        ...
        for jj in range(ixmin, ixmax+2):
            if (jj==ixmin):
              fh.write("sx(n,"+str(jj)+")*eyg(j(n)"+plusi(jj)+",k0(n)"+plusi(kk)+",l(n)"+plusi(ll)+") &\n");
            elif (jj==ixmax+1):
              fh.write(indent_2+"    + sx(n,"+str(jj)+")*eyg(j(n)"+plusi(jj)+",k0(n)"+plusi(kk)+",l(n)"+plusi(ll)+"))");
            else:
              fh.write(indent_2+"    + sx(n,"+str(jj)+")*eyg(j(n)"+plusi(jj)+",k0(n)"+plusi(kk)+",l(n)"+plusi(ll)+") &\n");
        fh.write("*sy0(n,"+str(kk)+")\n")
    fh.write(indent_2+"ey(nn) = ey(nn) + a*sz(n,"+str(ll)+")\n")
...
for ll in range(izmin0, izmax0+1):
    for kk in range(iymin, iymax+2):
        ...
        for jj in range(ixmin, ixmax+2):
            if (jj==ixmin):
              fh.write("sx(n,"+str(jj)+")*ezg(j(n)"+plusi(jj)+",k(n)"+plusi(kk)+",l0(n)"+plusi(ll)+") &\n");
            elif (jj==ixmax+1):
              fh.write(indent_2+"    + sx(n,"+str(jj)+")*ezg(j(n)"+plusi(jj)+",k(n)"+plusi(kk)+",l0(n)"+plusi(ll)+"))");
            else:
              fh.write(indent_2+"    + sx(n,"+str(jj)+")*ezg(j(n)"+plusi(jj)+",k(n)"+plusi(kk)+",l0(n)"+plusi(ll)+") &\n");
        fh.write("*sy(n,"+str(kk)+")\n")
    fh.write(indent_2+"ez(nn) = ez(nn) + a*sz0(n,"+str(ll)+")\n")
