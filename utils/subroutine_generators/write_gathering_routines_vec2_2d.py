...
subroutine_e_field="gete2dxz_energy_conserving_vec2_"+str(nox)+"_"+str(noz)
indent_cont_1="                                      "
indent_cont_2="              "
indent_1="  "
...
for ll in range(izmin0, izmax0+1):
        ...
        for jj in range(ixmin, ixmax+2):
            if (jj==ixmin):
              ...
              fh.write(indent_2+"    + sx(n,"+str(jj)+")*bxg(j"+plusi(jj)+",1,l0"+plusi(ll)+"))\n");
            else:
              fh.write(indent_2+"    + sx(n,"+str(jj)+")*bxg(j"+plusi(jj)+",1,l0"+plusi(ll)+") &\n"); 
        fh.write(indent_4+"bx(nn) = bx(nn) + a*sz0(n,"+str(ll)+")\n");
  ...
  for ll in range(izmin, izmax+2):
          ...
          for jj in range(ixmin0, ixmax0+1):
              if (jj==ixmin0):
                ...
                fh.write(indent_2+"    + sx0(n,"+str(jj)+")*bzg(j0"+plusi(jj)+",1,l"+plusi(ll)+"))\n");
              else:
                fh.write(indent_2+"    + sx0(n,"+str(jj)+")*bzg(j0"+plusi(jj)+",1,l"+plusi(ll)+") &\n"); 
  ...
  for jj in range(ixmin0, ixmax0+1):
          ...
          for ll in range(izmin, izmax+2):
              if (ll==izmin):
                ...
                fh.write(indent_2+"    + sz(n,"+str(ll)+")*bzg(j0"+plusi(jj)+",1,l"+plusi(ll)+"))\n");
              else:
                fh.write(indent_2+"    + sz(n,"+str(ll)+")*bzg(j0"+plusi(jj)+",1,l"+plusi(ll)+") &\n"); 
          fh.write(indent_4+"bz(nn) = bz(nn) + a*sx0(n,"+str(jj)+")\n");
