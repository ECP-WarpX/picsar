...
for ll in range(izmin0, izmax0+1):
    for kk in range(iymin0, iymax0+1):
        ...
        for jj in range(ixmin, ixmax+2):
            if (jj==ixmin):
              fh.write("sx(n,"+str(jj)+")*bxg(j"+plusi(jj)+",k0"+plusi(kk)+",l0"+plusi(ll)+") &\n");
            elif (jj==ixmax+1):
              fh.write(indent_2+"    + sx(n,"+str(jj)+")*bxg(j"+plusi(jj)+",k0"+plusi(kk)+",l0"+plusi(ll)+"))");
            else:
              fh.write(indent_2+"    + sx(n,"+str(jj)+")*bxg(j"+plusi(jj)+",k0"+plusi(kk)+",l0"+plusi(ll)+") &\n"); 
...
for ll in range(izmin0, izmax0+1):
    for kk in range(iymin, iymax+2):
        ...
        for jj in range(ixmin0, ixmax0+1):
            if (jj==ixmin0):
              fh.write("sx0(n,"+str(jj)+")*byg(j0"+plusi(jj)+",k"+plusi(kk)+",l0"+plusi(ll)+") &\n");
            elif (jj==ixmax0):
              fh.write(indent_2+"    + sx0(n,"+str(jj)+")*byg(j0"+plusi(jj)+",k"+plusi(kk)+",l0"+plusi(ll)+"))");
            else:
              fh.write(indent_2+"    + sx0(n,"+str(jj)+")*byg(j0"+plusi(jj)+",k"+plusi(kk)+",l0"+plusi(ll)+") &\n"); 
...
for ll in range(izmin, izmax+2):
    for kk in range(iymin0, iymax0+1):
        ...
        for jj in range(ixmin0, ixmax0+1):
            if (jj==ixmin0):
              fh.write("sx0(n,"+str(jj)+")*bzg(j0"+plusi(jj)+",k0"+plusi(kk)+",l"+plusi(ll)+") &\n");
            elif (jj==ixmax0):
              fh.write(indent_2+"    + sx0(n,"+str(jj)+")*bzg(j0"+plusi(jj)+",k0"+plusi(kk)+",l"+plusi(ll)+"))");
            else:
              fh.write(indent_2+"    + sx0(n,"+str(jj)+")*bzg(j0"+plusi(jj)+",k0"+plusi(kk)+",l"+plusi(ll)+") &\n");
        fh.write("*sy0(n,"+str(kk)+")\n")
...
for ll in range(izmin, izmax+2):
    for kk in range(iymin, iymax+2):
        ...
        for jj in range(ixmin0, ixmax0+1):
            if (jj==ixmin0):
              fh.write("sx0(n,"+str(jj)+")*exg(j0"+plusi(jj)+",k"+plusi(kk)+",l"+plusi(ll)+") &\n");
            elif (jj==ixmax0):
              fh.write(indent_2+"    + sx0(n,"+str(jj)+")*exg(j0"+plusi(jj)+",k"+plusi(kk)+",l"+plusi(ll)+"))");
            else:
              fh.write(indent_2+"    + sx0(n,"+str(jj)+")*exg(j0"+plusi(jj)+",k"+plusi(kk)+",l"+plusi(ll)+") &\n");
        fh.write("*sy(n,"+str(kk)+")\n")
...
for ll in range(izmin, izmax+2):
    for kk in range(iymin0, iymax0+1):
        ...
        for jj in range(ixmin, ixmax+2):
            if (jj==ixmin):
              fh.write("sx(n,"+str(jj)+")*eyg(j"+plusi(jj)+",k0"+plusi(kk)+",l"+plusi(ll)+") &\n");
            elif (jj==ixmax+1):
              fh.write(indent_2+"    + sx(n,"+str(jj)+")*eyg(j"+plusi(jj)+",k0"+plusi(kk)+",l"+plusi(ll)+"))");
            else:
              fh.write(indent_2+"    + sx(n,"+str(jj)+")*eyg(j"+plusi(jj)+",k0"+plusi(kk)+",l"+plusi(ll)+") &\n");
        fh.write("*sy0(n,"+str(kk)+")\n")
...
for ll in range(izmin0, izmax0+1):
    for kk in range(iymin, iymax+2):
        ...
        for jj in range(ixmin, ixmax+2):
            if (jj==ixmin):
              fh.write("sx(n,"+str(jj)+")*ezg(j"+plusi(jj)+",k"+plusi(kk)+",l0"+plusi(ll)+") &\n");
            elif (jj==ixmax+1):
              fh.write(indent_2+"    + sx(n,"+str(jj)+")*ezg(j"+plusi(jj)+",k"+plusi(kk)+",l0"+plusi(ll)+"))");
            else:
              fh.write(indent_2+"    + sx(n,"+str(jj)+")*ezg(j"+plusi(jj)+",k"+plusi(kk)+",l0"+plusi(ll)+") &\n");
        fh.write("*sy(n,"+str(kk)+")\n")
